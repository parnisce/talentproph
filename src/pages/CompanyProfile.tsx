...
const CompanyProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="w-full max-w-[1400px] mx-auto pt-32 px-6 pb-32">
                {/* Banner Section */}
                <div className="relative group">
                    <div className="relative h-[300px] md:h-[450px] rounded-[64px] overflow-hidden shadow-2xl">
                        <img
                    ...
                    {/* Company Logo Overlap - Moved outside overflow-hidden */}
                    <div className="absolute -bottom-1 left-12 md:left-20 translate-y-1/2 z-10 transition-all duration-500 hover:scale-110">
                ...
                {/* Content Section */}
                <div className="mt-24 md:mt-32 px-6 md:px-12 grid grid-cols-1 lg:grid-cols-3 gap-16">
                    {/* Left Column: Info */}
