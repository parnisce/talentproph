                ...
                <div className="px-12 pb-16 relative">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        <div className="-mt-32 relative group shrink-0">
                            ...
                            <div className={`absolute -bottom-2 -right-2 w-12 h-12 rounded-3xl border-4 border-white flex items-center justify-center text-white shadow-xl ${is_verified_pro ? 'bg-green-500' : 'bg-slate-300'}`}>
